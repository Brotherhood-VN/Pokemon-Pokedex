...
namespace API.Controllers.Systems
{
    ...
    public class RankController : ApiController
    {
        ...
        [MenuMember(2)]
        [HttpPost("Create")]
        public async Task<IActionResult> Create([FromBody] RankDto dto)
        {
            dto.CreateBy = UserId;
            dto.CreateTime = Now;
        ...
        [MenuMember(3)]
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] RankDto dto)
        {
            dto.UpdateBy = UserId;
            dto.UpdateTime = Now;
        ...
        [MenuMember(4)]
        [HttpPut("Delete")]
        public async Task<IActionResult> Delete([FromBody] RankDto dto)
        {
            dto.UpdateBy = UserId;
            dto.UpdateTime = Now;
        ...
        [ProducesResponseType(typeof(PaginationUtility<RankDto>), (int)HttpStatusCode.OK)]
        [MenuMember(1)]
        ...
        [HttpGet("GetListRank")]
        public async Task<IActionResult> GetListRank()
        {
            return Ok(await _service.GetListRank());
        }

        [ProducesResponseType(typeof(RankDto), (int)HttpStatusCode.OK)]
        [MenuMember(5)]
        [HttpGet("GetDetail")]
