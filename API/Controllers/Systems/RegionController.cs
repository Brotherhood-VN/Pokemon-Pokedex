...
namespace API.Controllers.Systems
{
    ...
    public class RegionController : ApiController
    {
        ...
        [MenuMember(3)]
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] RegionDto dto)
        {
            dto.UpdateBy = UserId;
            dto.UpdateTime = Now;
        ...
        [MenuMember(4)]
        [HttpPut("Delete")]
        public async Task<IActionResult> Delete([FromBody] RegionDto dto)
        {
            dto.UpdateBy = UserId;
            dto.UpdateTime = Now;
        ...
        [ProducesResponseType(typeof(PaginationUtility<RegionDto>), (int)HttpStatusCode.OK)]
        [MenuMember(1)]
        ...
        {
            return Ok(await _service.GetListRegion());
        }
