...
namespace API.Controllers.Systems
{
    ...
    public class AbilityController : ApiController
    {
        ...
        [MenuMember(2)]
        [HttpPost("Create")]
        public async Task<IActionResult> Create([FromBody] AbilityDto dto)
        {
            dto.CreateBy = UserId;
            dto.CreateTime = Now;
        ...
        [MenuMember(3)]
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] AbilityDto dto)
        {
            dto.UpdateBy = UserId;
            dto.UpdateTime = Now;
        ...
        [MenuMember(4)]
        [HttpPut("Delete")]
        public async Task<IActionResult> Delete([FromBody] AbilityDto dto)
        {
            dto.UpdateBy = UserId;
            dto.UpdateTime = Now;
        ...
        [ProducesResponseType(typeof(PaginationUtility<AbilityDto>), (int)HttpStatusCode.OK)]
        [MenuMember(1)]
        ...
        [HttpGet("GetListAbility")]
        public async Task<IActionResult> GetListAbility()
        {
            return Ok(await _service.GetListAbility());
        }

        [ProducesResponseType(typeof(AbilityDto), (int)HttpStatusCode.OK)]
        [MenuMember(5)]
        [HttpGet("GetDetail")]
